...
interface BiophysicalCanvasProps {
  vectors: PharmaVectors;
  activeCompoundId?: string;
  isSimulating: boolean;
}

export const BiophysicalCanvas: React.FC<BiophysicalCanvasProps> = ({ vectors, activeCompoundId, isSimulating }) => {
...
export default BiophysicalCanvas;
